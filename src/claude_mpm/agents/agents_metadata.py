...
ALL_AGENT_CONFIGS = {
    ...
    "version-control": VERSION_CONTROL_CONFIG,
    "qa": QA_CONFIG,
    "api-qa": API_QA_CONFIG,
    "web-qa": WEB_QA_CONFIG,
    "research": RESEARCH_CONFIG,
    "ops": OPS_CONFIG,
    "security": SECURITY_CONFIG,
    "engineer": ENGINEER_CONFIG,
    "data-engineer": DATA_ENGINEER_CONFIG,
    "project-organizer": PROJECT_ORGANIZER_CONFIG,
    "imagemagick": IMAGEMAGICK_CONFIG,
    "agentic-coder-optimizer": AGENTIC_CODER_OPTIMIZER_CONFIG,
    "agent-manager": AGENT_MANAGER_CONFIG,
}
